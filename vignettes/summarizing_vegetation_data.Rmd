...
The "$" allows you to access the elements at that location of the list. Here is an example of accessing a dataframe stored within the list structure. 
```{r}
Y222_summary$R232XY222AK$STM$state1$comm1$species_summary |> View()
```

**Summarizing pedon level soils data**
