...
```{r}
D104_summary$R232XD104AK$STM$state1$comm1$species_summary |> head()
```
...
```{r}
test <- ecositerSpatial::site_prism_annual_normals(site_df = D104_veg,
