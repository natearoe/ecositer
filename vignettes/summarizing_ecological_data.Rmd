...
I will be using an example dataset for this process as well because it is easier to access a whole survey area and reproducible for folks that do not have NASIS access.
```{r}
