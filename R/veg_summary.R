...
# }
#
# my_veg_df <- ecositer::create_veg_df(from = "SS")
#
#
# veg_summary(veg_df = my_veg_df)
#
#
#   # Convert to data.table
#   veg_df <- data.table::as.data.table(veg_df)
#
# #Determine if there are multiple vegplots for any of the siteiids
# if(best_vegplot){
#   veg_df <- ecositer::QC_best_vegplot_for_site(veg_df)
# }
#
#   # Updated taxonomies
#   if(update_taxonomy == TRUE){
#     veg_df <- ecositer::QC_update_taxonomy(veg_df)
#   }
#
#
